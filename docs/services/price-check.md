...
7.  Dateien und Verzeichnisse aus dem Build-Stage "builder" in das aktuelle Image kopieren:
    ...
    ```
7.  Dokumentieren, dass der Container auf Port 8086 lauscht und Benutzer, unter dem der Container ausgeführt wird, auf die Benutzer-ID 185 (nicht root) setzen:
    ```dockerfile
    EXPOSE 8086
    USER 185
    ```
