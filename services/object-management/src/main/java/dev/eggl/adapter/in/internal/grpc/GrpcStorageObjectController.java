...
@GrpcService
public class GrpcStorageObjectController implements ObjectService {

    private final InternalStorageObjectUseCase internalListStorageObjectUseCase;

    public GrpcStorageObjectController(InternalStorageObjectUseCase internalListStorageObjectUseCase) {
